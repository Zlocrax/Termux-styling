...
bar_cr="35" #color of bars
name_cr="32" #color of user & host
end_cr="37" #color of prompt end
dir_cr="37" #color of current directory

PS1='\[\033[0;${bar_cr}m\]┌──(\[\033[1;${name_cr}m\]${user_name}${sym}\h\[\033[0;>
...
alias randir='mkdir -p ./$(cat /dev/urandom | tr -cd 'a-z' | head -c 4)/$(cat /de>
...
alias kn='python /data/data/com.termux/files/home/keynote/keynote.py' # https://g>
...
#### Display ########################
#### change termux header here ###########
figlet -f <fonthere> <name Here>
